          ...
          >
            <div className="flex grid grid-cols-3 md:grid-cols-2 gap-4 w-full">
              <div className='block md:hidden'>
                <svg className="w-6 h-6 md:w-10 md:h-10 md:pt-2" aria-hidden="true" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M3 5a1 1 0 011-1h12a1 1 0 110 2H4a1 1 0 01-1-1zM3 10a1 1 0 011-1h12a1 1 0 110 2H4a1 1 0 01-1-1zM3 15a1 1 0 011-1h12a1 1 0 110 2H4a1 1 0 01-1-1z" clip-rule="evenodd"></path></svg>
              </div>
              <div>
