...
export default function Index() {
    ...
    <>
      <div className='block sm:hidden'>
        ...
        <div className="grid grid-cols-2 gap-4 content-center px-6">
            <div className="image-half-circle-sm"></div>
            <div className="image-half-circle1-sm"></div>
        </div>
        ...
        <div className="grid grid-cols-1 gap-4 content-center pb-4 mb-4">
          <div className="girl3">
            <div className="relative h-full w-full">
              <div className="absolute inset-x-0 bottom-0 h-26 mb-8 pb-8">
                <div className="grid grid-cols-1 gap-4 content-center text-center">
        ...
        <div className="grid grid-cols-1 gap-4" style={{ backgroundColor: '#D5D5D7' }}>
          <div className="girl-sm"></div>
        </div>
        <div className="grid grid-cols-1 gap-4 content-center px-6 pb-6" style={{ backgroundColor: '#D5D5D7' }}>
        ...
        <div className="grid grid-cols-2 gap-4 px-6">
          <div className="fashion-sm mt-8"></div>
          <div>
            <div className="flex flex-col gap-4">
              ...
              <div className="grid grid-cols-2 gap-4 pb-4 mb-4">
                <div className="girl-brown-sm"></div>
                <div className="girl-green-sm"></div>
              </div>
            </div>
          </div>
        </div>
